...
- Develop and improve Kyutai’s open-science text-to-speech (TTS) models, which convert written text into spoken words.
...
able to use your voice to say anything.** The voice recording is not
linked to your personal information in any way, but of course, it can
still be possible to recognize you by the voice.
